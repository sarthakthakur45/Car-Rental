...
$sql = "delete from car SET id=:status WHERE  id=:delid";
...
<?php $sql = "SELECT car.VehiclesTitle,tblbrands.BrandName,car.PricePerDay,car.FuelType,car.ModelYear,car.id from car join tblbrands on tblbrands.id=car.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
