...
<?php 
$useremail=$_SESSION['login'];
 $sql = "SELECT car.Vimage1 as Vimage1,car.VehiclesTitle,car.id as vid,tblbrands.BrandName,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.Status  from tblbooking join car on tblbooking.VehicleId=car.id join tblbrands on tblbrands.id=car.VehiclesBrand where tblbooking.userEmail=:useremail";
$query = $dbh -> prepare($sql);
$query-> bindParam(':useremail', $useremail, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
<li>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Not Confirm yet</a>
            <div class="clearfix"></div>
                ...
                <?php } ?>
       <div style="float: left"><p><b>License No.:</b> <?php echo htmlentities($result->message);?> </p></div>
              </li>
              <?php }} ?>
