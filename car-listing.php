...
<head>
  ...
  <title>Car Rental System | Car Listing</title>
  <!--Bootstrap -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-9">
          ...
          <?php $sql = "SELECT car.*,tblbrands.BrandName,tblbrands.id as bid  from car join tblbrands on tblbrands.id=car.VehiclesBrand";
          $query = $dbh->prepare($sql);
          $query->execute();
          $results = $query->fetchAll(PDO::FETCH_OBJ);
          $cnt = 1;
        ...
        <aside class="col-md-3">
          ...
          <!-- <div class="sidebar_widget">
            ...
            <div class="recent_addedcars">
              <ul>
                <?php $sql = "SELECT car.*,tblbrands.BrandName,tblbrands.id as bid  from car join tblbrands on tblbrands.id=car.VehiclesBrand order by id desc limit 4";
                $query = $dbh->prepare($sql);
                $query->execute();
                $results = $query->fetchAll(PDO::FETCH_OBJ);
                $cnt = 1;
