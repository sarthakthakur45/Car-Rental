        ...
        <div class="col-md-9">
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
              ...
              $sql = "SELECT id from car where car.VehiclesBrand=:brand and car.FuelType=:fueltype";
          ...
          $sql = "SELECT car.*,tblbrands.BrandName,tblbrands.id as bid  from car join tblbrands on tblbrands.id=car.VehiclesBrand where car.VehiclesBrand=:brand and car.FuelType=:fueltype";
          $query = $dbh->prepare($sql);
          $query->bindParam(':brand', $brand, PDO::PARAM_STR);
          $query->bindParam(':fueltype', $fueltype, PDO::PARAM_STR);
          $query->execute();
